...
test_that("one tic works", {
  ...
  ppl <- list(
    list(father = NA, mother = NA, due_date = NA, to_reproduce = FALSE, current_partner = NA, female = TRUE, age = 1, date_of_death = NA, is_alive = TRUE, is_present = TRUE),
    list(father = NA, mother = NA, due_date = NA, to_reproduce = FALSE, current_partner = NA, female = TRUE, age = 2, date_of_death = NA, is_alive = TRUE, is_present = TRUE),
    list(father = NA, mother = NA, due_date = NA, to_reproduce = FALSE, current_partner = NA, female = TRUE, age = 1, date_of_death = 0, is_alive = FALSE, is_present = FALSE)
...
#   ppl <- list(
#     list(father = NA, mother = NA, due_date = NA, current_partner = NA, female = TRUE, age = 1, date_of_death = NA, is_alive = TRUE, is_present = TRUE),
#     list(father = NA, mother = NA, due_date = NA, current_partner = NA, female = TRUE, age = 2, date_of_death = NA, is_alive = TRUE, is_present = TRUE),
#     list(father = NA, mother = NA, due_date = NA, current_partner = NA, female = TRUE, age = 1, date_of_death = 0, is_alive = FALSE, is_present = FALSE)
#   ) %>% bind_rows() %>% as.data.frame()
...
#       censuses %>% record_census(ppl, today, interval) -> censuses
#     }
#   })
